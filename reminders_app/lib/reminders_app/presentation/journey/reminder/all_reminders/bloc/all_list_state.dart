...
class AllRemindersState extends Equatable {
 ...
 final bool isUpdated;
  AllRemindersState({@required this.myLists,@required this.remindersOfList, this.isUpdated});

  AllRemindersState update({  List<Group> myLists,Map<String,List<Reminder>> remindersOfList,bool isUpdated }) =>
      AllRemindersState(
